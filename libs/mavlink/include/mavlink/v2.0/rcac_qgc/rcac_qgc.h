/** @file
 *  @brief MAVLink comm protocol generated from rcac_qgc.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_RCAC_QGC_H
#define MAVLINK_RCAC_QGC_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_RCAC_QGC.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#include "./mavlink_msg_rcac_mode_sc.h"
