...
#define MAVLINK_MSG_ID_RCAC_ATT_RATE_VARIABLES_LEN 134
#define MAVLINK_MSG_ID_RCAC_ATT_RATE_VARIABLES_MIN_LEN 134
#define MAVLINK_MSG_ID_10001_LEN 134
#define MAVLINK_MSG_ID_10001_MIN_LEN 134

#define MAVLINK_MSG_ID_RCAC_ATT_RATE_VARIABLES_CRC 206
#define MAVLINK_MSG_ID_10001_CRC 206
...
#define MAVLINK_MESSAGE_INFO_RCAC_ATT_RATE_VARIABLES { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_rcac_att_rate_variables_t, timestamp) }, \
         ...
         { "switch_att", NULL, MAVLINK_TYPE_UINT8_T, 0, 132, offsetof(mavlink_rcac_att_rate_variables_t, switch_att) }, \
         ...
         { "switch_rate", NULL, MAVLINK_TYPE_UINT8_T, 0, 133, offsetof(mavlink_rcac_att_rate_variables_t, switch_rate) }, \
...
static inline uint16_t mavlink_msg_rcac_att_rate_variables_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint64_t ii_att, uint8_t switch_att, const float *rcac_att_z, const float *rcac_att_u, const float *rcac_att_theta, uint64_t ii_rate, uint8_t switch_rate, const float *rcac_rate_z, const float *rcac_rate_u, const float *rcac_rate_theta)
{
    ...
    _mav_put_uint8_t(buf, 132, switch_att);
    _mav_put_uint8_t(buf, 133, switch_rate);
