...
#define MAVLINK_MSG_ID_RCAC_POS_VEL_VARIABLES_CRC 2
#define MAVLINK_MSG_ID_10002_CRC 2
...
#define MAVLINK_MESSAGE_INFO_RCAC_POS_VEL_VARIABLES { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_rcac_pos_vel_variables_t, timestamp) }, \
         ...
         { "rcac_pos_z", NULL, MAVLINK_TYPE_FLOAT, 3, 36, offsetof(mavlink_rcac_pos_vel_variables_t, rcac_pos_z) }, \
         { "rcac_pos_u", NULL, MAVLINK_TYPE_FLOAT, 3, 48, offsetof(mavlink_rcac_pos_vel_variables_t, rcac_pos_u) }, \
         { "rcac_pos_theta", NULL, MAVLINK_TYPE_FLOAT, 3, 60, offsetof(mavlink_rcac_pos_vel_variables_t, rcac_pos_theta) }, \
         ...
         { "rcac_vel_z", NULL, MAVLINK_TYPE_FLOAT, 3, 76, offsetof(mavlink_rcac_pos_vel_variables_t, rcac_vel_z) }, \
         { "rcac_vel_u", NULL, MAVLINK_TYPE_FLOAT, 3, 88, offsetof(mavlink_rcac_pos_vel_variables_t, rcac_vel_u) }, \
         { "rcac_vel_theta", NULL, MAVLINK_TYPE_FLOAT, 9, 100, offsetof(mavlink_rcac_pos_vel_variables_t, rcac_vel_theta) }, \
         { "px4_ol_theta", NULL, MAVLINK_TYPE_FLOAT, 9, 136, offsetof(mavlink_rcac_pos_vel_variables_t, px4_ol_theta) }, \
...
static inline uint16_t mavlink_msg_rcac_pos_vel_variables_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, float pid_factor, float rcac_master_sw, uint64_t ii_pos, uint8_t switch_pos, float alpha_pid_pos, const float *rcac_pos_z, const float *rcac_pos_u, const float *rcac_pos_theta, uint64_t ii_vel, uint8_t switch_vel, float alpha_pid_vel, const float *rcac_vel_z, const float *rcac_vel_u, const float *rcac_vel_theta, const float *px4_ol_theta, float p11_pos, float p11_velx)
{
    ...
    _mav_put_float_array(buf, 36, rcac_pos_z, 3);
    _mav_put_float_array(buf, 48, rcac_pos_u, 3);
    _mav_put_float_array(buf, 60, rcac_pos_theta, 3);
    _mav_put_float_array(buf, 76, rcac_vel_z, 3);
    _mav_put_float_array(buf, 88, rcac_vel_u, 3);
    _mav_put_float_array(buf, 100, rcac_vel_theta, 9);
    _mav_put_float_array(buf, 136, px4_ol_theta, 9);
...
{
    return mavlink_msg_rcac_pos_vel_variables_pack(system_id, component_id, msg, rcac_pos_vel_variables->timestamp, rcac_pos_vel_variables->pid_factor, rcac_pos_vel_variables->rcac_master_sw, rcac_pos_vel_variables->ii_pos, rcac_pos_vel_variables->switch_pos, rcac_pos_vel_variables->alpha_pid_pos, rcac_pos_vel_variables->rcac_pos_z, rcac_pos_vel_variables->rcac_pos_u, rcac_pos_vel_variables->rcac_pos_theta, rcac_pos_vel_variables->ii_vel, rcac_pos_vel_variables->switch_vel, rcac_pos_vel_variables->alpha_pid_vel, rcac_pos_vel_variables->rcac_vel_z, rcac_pos_vel_variables->rcac_vel_u, rcac_pos_vel_variables->rcac_vel_theta, rcac_pos_vel_variables->px4_ol_theta, rcac_pos_vel_variables->p11_pos, rcac_pos_vel_variables->p11_velx);
}
...
static inline void mavlink_msg_rcac_pos_vel_variables_send(mavlink_channel_t chan, uint64_t timestamp, float pid_factor, float rcac_master_sw, uint64_t ii_pos, uint8_t switch_pos, float alpha_pid_pos, const float *rcac_pos_z, const float *rcac_pos_u, const float *rcac_pos_theta, uint64_t ii_vel, uint8_t switch_vel, float alpha_pid_vel, const float *rcac_vel_z, const float *rcac_vel_u, const float *rcac_vel_theta, const float *px4_ol_theta, float p11_pos, float p11_velx)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_RCAC_POS_VEL_VARIABLES_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rcac_pos_vel_variables_send(chan, rcac_pos_vel_variables->timestamp, rcac_pos_vel_variables->pid_factor, rcac_pos_vel_variables->rcac_master_sw, rcac_pos_vel_variables->ii_pos, rcac_pos_vel_variables->switch_pos, rcac_pos_vel_variables->alpha_pid_pos, rcac_pos_vel_variables->rcac_pos_z, rcac_pos_vel_variables->rcac_pos_u, rcac_pos_vel_variables->rcac_pos_theta, rcac_pos_vel_variables->ii_vel, rcac_pos_vel_variables->switch_vel, rcac_pos_vel_variables->alpha_pid_vel, rcac_pos_vel_variables->rcac_vel_z, rcac_pos_vel_variables->rcac_vel_u, rcac_pos_vel_variables->rcac_vel_theta, rcac_pos_vel_variables->px4_ol_theta, rcac_pos_vel_variables->p11_pos, rcac_pos_vel_variables->p11_velx);
#else
 ...
 */
static inline void mavlink_msg_rcac_pos_vel_variables_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, float pid_factor, float rcac_master_sw, uint64_t ii_pos, uint8_t switch_pos, float alpha_pid_pos, const float *rcac_pos_z, const float *rcac_pos_u, const float *rcac_pos_theta, uint64_t ii_vel, uint8_t switch_vel, float alpha_pid_vel, const float *rcac_vel_z, const float *rcac_vel_u, const float *rcac_vel_theta, const float *px4_ol_theta, float p11_pos, float p11_velx)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float_array(msg, rcac_pos_z, 3,  36);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_pos_u, 3,  48);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_pos_theta, 3,  60);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_vel_z, 3,  76);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_vel_u, 3,  88);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_vel_theta, 9,  100);
}
...
{
    return _MAV_RETURN_float_array(msg, px4_ol_theta, 9,  136);
}
