...
#define MAVLINK_MSG_ID_RCAC_ATT_RATE_VARIABLES_CRC 239
#define MAVLINK_MSG_ID_10001_CRC 239
...
#define MAVLINK_MESSAGE_INFO_RCAC_ATT_RATE_VARIABLES { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_rcac_att_rate_variables_t, timestamp) }, \
         ...
         { "rcac_att_z", NULL, MAVLINK_TYPE_FLOAT, 3, 28, offsetof(mavlink_rcac_att_rate_variables_t, rcac_att_z) }, \
         { "rcac_att_u", NULL, MAVLINK_TYPE_FLOAT, 3, 40, offsetof(mavlink_rcac_att_rate_variables_t, rcac_att_u) }, \
         { "rcac_att_theta", NULL, MAVLINK_TYPE_FLOAT, 3, 52, offsetof(mavlink_rcac_att_rate_variables_t, rcac_att_theta) }, \
         ...
         { "rcac_rate_z", NULL, MAVLINK_TYPE_FLOAT, 3, 68, offsetof(mavlink_rcac_att_rate_variables_t, rcac_rate_z) }, \
         { "rcac_rate_u", NULL, MAVLINK_TYPE_FLOAT, 3, 80, offsetof(mavlink_rcac_att_rate_variables_t, rcac_rate_u) }, \
         { "rcac_rate_theta", NULL, MAVLINK_TYPE_FLOAT, 12, 92, offsetof(mavlink_rcac_att_rate_variables_t, rcac_rate_theta) }, \
         { "px4_att_theta", NULL, MAVLINK_TYPE_FLOAT, 3, 140, offsetof(mavlink_rcac_att_rate_variables_t, px4_att_theta) }, \
         { "px4_rate_theta", NULL, MAVLINK_TYPE_FLOAT, 12, 152, offsetof(mavlink_rcac_att_rate_variables_t, px4_rate_theta) }, \
...
static inline uint16_t mavlink_msg_rcac_att_rate_variables_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint64_t ii_att, uint8_t switch_att, float alpha_pid_att, const float *rcac_att_z, const float *rcac_att_u, const float *rcac_att_theta, uint64_t ii_rate, uint8_t switch_rate, float alpha_pid_rate, const float *rcac_rate_z, const float *rcac_rate_u, const float *rcac_rate_theta, const float *px4_att_theta, const float *px4_rate_theta, float p11_att, float p11_ratex)
{
    ...
    _mav_put_float_array(buf, 28, rcac_att_z, 3);
    _mav_put_float_array(buf, 40, rcac_att_u, 3);
    _mav_put_float_array(buf, 52, rcac_att_theta, 3);
    _mav_put_float_array(buf, 68, rcac_rate_z, 3);
    _mav_put_float_array(buf, 80, rcac_rate_u, 3);
    _mav_put_float_array(buf, 92, rcac_rate_theta, 12);
    _mav_put_float_array(buf, 140, px4_att_theta, 3);
    _mav_put_float_array(buf, 152, px4_rate_theta, 12);
...
{
    return mavlink_msg_rcac_att_rate_variables_pack(system_id, component_id, msg, rcac_att_rate_variables->timestamp, rcac_att_rate_variables->ii_att, rcac_att_rate_variables->switch_att, rcac_att_rate_variables->alpha_pid_att, rcac_att_rate_variables->rcac_att_z, rcac_att_rate_variables->rcac_att_u, rcac_att_rate_variables->rcac_att_theta, rcac_att_rate_variables->ii_rate, rcac_att_rate_variables->switch_rate, rcac_att_rate_variables->alpha_pid_rate, rcac_att_rate_variables->rcac_rate_z, rcac_att_rate_variables->rcac_rate_u, rcac_att_rate_variables->rcac_rate_theta, rcac_att_rate_variables->px4_att_theta, rcac_att_rate_variables->px4_rate_theta, rcac_att_rate_variables->p11_att, rcac_att_rate_variables->p11_ratex);
}
...
static inline void mavlink_msg_rcac_att_rate_variables_send(mavlink_channel_t chan, uint64_t timestamp, uint64_t ii_att, uint8_t switch_att, float alpha_pid_att, const float *rcac_att_z, const float *rcac_att_u, const float *rcac_att_theta, uint64_t ii_rate, uint8_t switch_rate, float alpha_pid_rate, const float *rcac_rate_z, const float *rcac_rate_u, const float *rcac_rate_theta, const float *px4_att_theta, const float *px4_rate_theta, float p11_att, float p11_ratex)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_RCAC_ATT_RATE_VARIABLES_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static inline void mavlink_msg_rcac_att_rate_variables_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint64_t ii_att, uint8_t switch_att, float alpha_pid_att, const float *rcac_att_z, const float *rcac_att_u, const float *rcac_att_theta, uint64_t ii_rate, uint8_t switch_rate, float alpha_pid_rate, const float *rcac_rate_z, const float *rcac_rate_u, const float *rcac_rate_theta, const float *px4_att_theta, const float *px4_rate_theta, float p11_att, float p11_ratex)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float_array(msg, rcac_att_z, 3,  28);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_att_u, 3,  40);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_att_theta, 3,  52);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_rate_z, 3,  68);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_rate_u, 3,  80);
}
...
{
    return _MAV_RETURN_float_array(msg, rcac_rate_theta, 12,  92);
}
...
{
    return _MAV_RETURN_float_array(msg, px4_att_theta, 3,  140);
}
...
{
    return _MAV_RETURN_float_array(msg, px4_rate_theta, 12,  152);
}
