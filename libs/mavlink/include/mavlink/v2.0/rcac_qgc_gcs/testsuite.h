/** @file
 *    @brief MAVLink comm protocol testsuite generated from rcac_qgc_gcs.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef RCAC_QGC_GCS_TESTSUITE_H
#define RCAC_QGC_GCS_TESTSUITE_H
...
static void mavlink_test_rcac_qgc_gcs(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_common(system_id, component_id, last_msg);
    mavlink_test_rcac_qgc_gcs(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_rcac_qgc_gcs(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
...
#endif // __cplusplus
#endif // RCAC_QGC_GCS_TESTSUITE_H
