/** @file
 *	@brief MAVLink comm protocol generated from rcac.xml
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_rcac_att_rate_variables.hpp"
#include "./mavlink_msg_rcac_pos_vel_variables.hpp"
#include "./mavlink_msg_rcac_mode_sc.hpp"
