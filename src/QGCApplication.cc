    ...
    , _runningUnitTests     (unitTesting)
{
    ...
    if (_runningUnitTests) {
        ...
        // applicationName = QStringLiteral("%1 Daily").arg(QGC_APPLICATION_NAME); //JUAN: Changed to display RCAC name
        applicationName = QStringLiteral("%1 RCAC").arg(QGC_APPLICATION_NAME);
#else
